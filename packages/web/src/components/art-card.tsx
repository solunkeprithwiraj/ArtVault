    ...
    >
      ...
      <div className={`flex-1 ${isListView ? 'flex items-center justify-between gap-4 py-3 pr-4' : 'p-4'}`}>
        ...
        {isListView && (
          <div className="flex shrink-0 items-center gap-1">
            ...
            <Link href={`/edit/${piece.id}`} className="p-2.5 text-themed-muted hover:text-themed sm:p-1.5">
      ...
      {!isListView && !selectMode && (
        <div className="absolute right-2 top-2 hidden gap-1 opacity-0 transition-opacity group-hover:opacity-100 sm:flex">
          ...
          <Link href={`/edit/${piece.id}`} onClick={(e) => e.stopPropagation()} className="rounded-full bg-black/60 p-2 text-neutral-400 hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
              <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" />
            </svg>
